...
class VGGT(nn.Module, PyTorchModelHubMixin):
    ...
    def forward(self, images: torch.Tensor, rf: torch.Tensor = None, query_points: torch.Tensor = None):
        """
        ...
        aggregated_tokens_list, patch_start_idx = self.aggregator(images, rf=rf)
