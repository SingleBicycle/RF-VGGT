...
from vggt.models.rf_modules import build_rf_encoder, RFGatedTokenFusion
...
class Aggregator(nn.Module):
    ...
    def forward(self, images: torch.Tensor, rf: torch.Tensor = None) -> Tuple[List[torch.Tensor], int]:
        """
        Args:
        ...
        if self.enable_rf and rf is not None:
            if rf.ndim != 5:
            ...
            rf_tokens = self.rf_encoder(rf.reshape(B * S, rf.shape[2], rf.shape[3], rf.shape[4]))
